      ...
      <MyGrid item xs={12} md={6}>
          ...
          <Grid item  xs={12}  sm={12} md={12}>
              ...
              <div data-aos="fade-right" data-aos-offset="" data-aos-easing="ease-out-quart" >
                <Mypara>
                  We have both software and hardware solutions for industries to automate and control devices & equipments. Our software can be  customizable according to factory needs with various analytical graphs to monitor factory operation. Our hardware is fully customizable from PCB level to reduce the production cost and to fit the client requirements<br/> <br/> 
          <b>  Features</b>
            <ul>
         
              <li>Customizable IIoT software </li>
              <li>Customizable IIoT hardware </li>
